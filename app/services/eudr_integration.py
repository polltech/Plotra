...
class EUDRIntegrationService:
    ...
    def calculate_compliance_score(
        ...
        """
        requirements = {
            "deforestation_free": 30,  # Weight for deforestation status
            "legal_ownership": 25,      # Weight for legal ownership
            "traceability_verified": 25, # Weight for traceability
            "documents_complete": 10,    # Weight for document completeness
            "satellite_analysis": 10     # Weight for satellite analysis
        }
